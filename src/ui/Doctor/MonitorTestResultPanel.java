 ...
 * @author vidhisejpal
 */
public class MonitorTestResultPanel extends javax.swing.JPanel {
    ...
    String photo;
    Logger logger = LogManager.getLogger(MonitorTestResultPanel.class);
    public MonitorTestResultPanel(Long id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        strainDetected.setEditable(false);
        ...
        sugarDetected.setEditable(false);
        ...
        vitaminLevel.setEditable(false);
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {viewPhotoButton, viewTestButton});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {viewPhotoButton, viewTestButton});
...
//                        photo.setText(dbResult.getString(7));
    ...
    private void findTableData() {
        ...
        try {
            dbConn = db.getConnection();
            if (dbConn != null) {
                sqlStatement = dbConn.prepareStatement("select * from TestResult where docId = ?;");
